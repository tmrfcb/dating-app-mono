  ...
  return (
    <div>
      <h2 id="country-heading">
        <Translate contentKey="datingApp.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="datingApp.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('datingApp.country.home.search')}
                />
        ...
        {countryList && countryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('countryName')}>
                  <Translate contentKey="datingApp.country.countryName">Country Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="datingApp.country.location">Location</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {countryList.map((country, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{country.location ? <Link to={`location/${country.location.id}`}>{country.location.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="datingApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
