  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="datingApp.location.home.createOrEditLabel">
            <Translate contentKey="datingApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : locationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="streetAddressLabel" for="location-streetAddress">
                  <Translate contentKey="datingApp.location.streetAddress">Street Address</Translate>
                </Label>
                <AvField id="location-streetAddress" type="text" name="streetAddress" />
              </AvGroup>
              <AvGroup>
                <Label id="postalCodeLabel" for="location-postalCode">
                  <Translate contentKey="datingApp.location.postalCode">Postal Code</Translate>
                </Label>
                <AvField id="location-postalCode" type="text" name="postalCode" />
              </AvGroup>
              <AvGroup>
                <Label id="cityLabel" for="location-city">
                  <Translate contentKey="datingApp.location.city">City</Translate>
                </Label>
                <AvField id="location-city" type="text" name="city" />
              </AvGroup>
              <AvGroup>
                <Label id="stateProvinceLabel" for="location-stateProvince">
                  <Translate contentKey="datingApp.location.stateProvince">State Province</Translate>
                </Label>
                <AvField id="location-stateProvince" type="text" name="stateProvince" />
              </AvGroup>
              <AvGroup>
                <Label id="gpsLabel" for="location-gps">
                  <Translate contentKey="datingApp.location.gps">Gps</Translate>
                </Label>
                <AvField id="location-gps" type="string" className="form-control" name="gps" />
              </AvGroup>
